...
<br>
 <label for="username"><h1>First Name</h1></label>
    <input type="text" id="usrname" name="first" required>
    <br>
    <label for="username"><h1>Last Name</h1></label>
    <input type="text" id="usrname" name="last" required>
   
    <br>
    <label for="username"><h1>Mobile no</h1></label>
    <input type="text" id="usrname" name="tel" required>
    <br>
    <label for="username"><h1>Email</h1></label>
